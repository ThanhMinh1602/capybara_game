              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  ...
                  child: Card(
                    ...
                    child: Image.asset(datas[index].identifier),
                  ),
                );
              },
            );
    ...
    Widget _buildBottomHeader({
      ...
      return Positioned(
        ...
        child: Row(
          children: [
            _buildPointItem(
                iconPath: Assets.icons.png.helpNumber.path, point: leftPoint),
            const Spacer(),
            ...
            const Spacer(),
            _buildPointItem(
                iconPath: Assets.icons.png.crownIcon.path, point: rightPoint)
          ],
        ),
      );
    }
